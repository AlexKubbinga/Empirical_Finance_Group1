...
I am not completely sure why though so this needs more information
...
Covariance is a statistical measure that lets us know how our stocks returns move in compariason to each other. A positive covariance means they move together and a negatice means they move opposite. Though it sounds like covariance and correlation are the same they have a key difference. Covariance will tell us the direction a stock will move in comparisom to another while correlation tells us the strength of the relationship between the stocks. All of the covariances are positive which means that the returns of all of our stocks will somewhat move together.
