...
The first PC explains 98% of the variation in the data and the first 3 PCs explain 99% of the variation in the data. 

We also plotted a time series of the first 3 PCs. As we can see PC2 and PC3 are relatively similar with PC2 having slightly more variation. PC1 clearly has the most variation. PC1 is green, PC2 is blue and PC3 is red.
```{r}
...
final %>% ggplot() + geom_point(aes(x=PS4_Daily.date,y=PC1), color="green") + geom_point(aes(x=PS4_Daily.date,y=PC2), color="blue") +
  geom_point(aes(x=PS4_Daily.date,y=PC3), color="red") + labs(
    x="Date",
    y="PCs",
    title = "Time series plot of PCs (G=1,B=2,R=3)"
  )
